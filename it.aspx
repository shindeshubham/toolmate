<%@ Page Language="VB" AutoEventWireup="false" CodeFile="it.aspx.vb" Inherits="Default3" %>
		...
		<div style="padding: 50px; margin-right: 10px; margin-left: 250px; width: 690px; height: 78px;">
		    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:ImageField DataImageUrlField="path" HeaderText="ProductProfile" controlStyle-Width="100"
                        SortExpression="path" ItemStyle-Width="300" 
            ...
            <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                ...
                SelectCommand="SELECT [pname], [pdesc], [path], [yr], [dept], [price], [user] FROM [products] WHERE ([dept] = ?)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="IT" Name="dept" Type="String" />
                </SelectParameters>
