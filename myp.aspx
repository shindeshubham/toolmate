<%@ Page Language="VB" AutoEventWireup="false" CodeFile="myp.aspx.vb" Inherits="myp" %>
...
<li><a href="po.aspx">POLY</a></li>
		...
		<div style="padding: 50px; margin-right: 10px; margin-left: 250px; width: 690px; height: 78px;">
            ...
            <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                ...
                SelectCommand="SELECT [pname], [pdesc], [path], [yr], [dept], [price], [user] FROM [products] WHERE ([user] = ?)">
                <SelectParameters>
                    <asp:FormParameter FormField="usr" Name="user" Type="String" />
                </SelectParameters>
