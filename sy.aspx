<%@ Page Language="VB" AutoEventWireup="false" CodeFile="sy.aspx.vb" Inherits="sy" %>
		...
		<div style="padding: 50px; margin-right: 10px; margin-left: 250px; width: 690px; height: 78px;">
		    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:ImageField DataImageUrlField="Path"  HeaderText="ProductProfile" SortExpression="ProductProfile" ControlStyle-Width="100" 
                        ItemStyle-Width="300" ItemStyle-HorizontalAlign="Center"/>
            ...
            <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="SECOND YEAR" Name="yr" Type="String" />
                </SelectParameters>
